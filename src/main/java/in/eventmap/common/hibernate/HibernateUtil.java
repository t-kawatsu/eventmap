...
public class HibernateUtil {
	...
	/*
	 * private static final String DEFAULT_PERSISTENCE_UNIT =
	 * "in.eventmap.hibernate.jpa"; private static final EntityManagerFactory
	 * entityManagerFactory = buildEntityManagerFactory(
	 * HibernateUtil.DEFAULT_PERSISTENCE_UNIT ); private static final
	 * ThreadLocal<EntityManager> ENTITY_MANAGERS = new
	 ...
	 */
	/*
	 * private static EntityManagerFactory buildEntityManagerFactory( String
	 * unit ) { return Persistence.createEntityManagerFactory( unit ); }
	 * 
	 ...
	 * ENTITY_MANAGERS.get(); }
	 * 
	 * public static void removeEntityManager() { EntityManager em =
	 * ENTITY_MANAGERS.get(); if(em != null) { em.close(); }
	 * ENTITY_MANAGERS.remove(); }
	 * 
	 * public static void setEntityManager(EntityManager em) {
	 * HibernateUtil.ENTITY_MANAGERS.set(em); }
	 * 
	 * public static void closeEntityManagerFactory() { if(entityManagerFactory
