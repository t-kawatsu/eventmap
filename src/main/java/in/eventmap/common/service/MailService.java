...
import in.eventmap.common.util.SimpleMailSender;
...
public class MailService {
	...
	public void sendMailByCode(final String code, final String to,
		...
		defReplaces.put("top_url",
				urlHelper.buildUrl("/", null, true, false, "/"));
		defReplaces.put("inquiry_url",
				urlHelper.buildUrl("/inquiry", null, true, true, "/"));
	...
	public void sendCreateTmpUserComplete(String mailAddress, String token)
		...
		sendMailByCode("F01", mailAddress, "tmp-user-complete@"
	...
	public void sendPassword(String mailAddress, String password)
		...
		sendMailByCode("F03", mailAddress,
				"send-password@" + simpleMailSender.getFromDomain(), replaces);
	}
	...
	public void sendInquiryToSupport(String supportMailAddress, Inquiry inquiry)
			throws Exception {
		Map<String, String> replaces = new HashMap<String, String>();
		...
		sendMailByCode("F05", supportMailAddress,
				"inquiry@" + simpleMailSender.getFromDomain(), replaces);
	}

	public void sendRequestToSupport(String supportMailAddress, Request request)
			throws Exception {
		Map<String, String> replaces = new HashMap<String, String>();
		...
		sendMailByCode("F06", supportMailAddress,
				"request@" + simpleMailSender.getFromDomain(), replaces);
	}
}
