...
public class UrlHelper {
	...
	public String getBaseUrl(boolean useSsl) {
		if (useSsl) {
			useSsl = Boolean.valueOf(tp.getText("app.useSSL"));
		}

		String scheme = useSsl ? "https" : "http";
		String domain = tp.getText("app.site.domain");
		String port = useSsl ? tp.getText("app.site.sslPort", "443") : tp
				.getText("app.site.port", "80");
