...
public class UserImageMethod implements TemplateMethodModel {
	...
	public TemplateModel exec(@SuppressWarnings("rawtypes") List args)
		...
		ImageSize is = UserImageSize.nameOf((String) args.get(2));
	...
	private ImageService getImageService() {
		...
		if (imageService == null) {
			imageService = (ImageService) context.getBean("userImageService");
		}
		return imageService;
	}
}
